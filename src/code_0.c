...
void RenderHUDTop(void) {
    ...
    if (gUnk_03002920[0xB].onScreen == 1) {
            ...
            if (gUnk_03002920[0xB].affineDouble) {
                if (gUnk_03002920[0xB].kind == 0x1C) {
                    gUnk_03000820->split.x
                        = (var_r5->unk3 * 2) + gUnk_03002920[0xB].xPosScreen + ((s32)(gUnk_03002920[0xB].xOffset) << 4);
                    gUnk_03000820->split.y = var_r5->unk4 + ((s8)var_r5->unk4 >> 1) + gUnk_03002920[0xB].yPosScreen
                        + (((s8)gUnk_03002920[0xB].yOffset) << 4);
                } else {
                    gUnk_03000820->split.x
                        = (var_r5->unk3 * 2) + gUnk_03002920[0xB].xPosScreen + ((s32)(gUnk_03002920[0xB].xOffset << 4) >> 4);
                    gUnk_03000820->split.y
                        = var_r5->unk4 + ((s8)var_r5->unk4 >> 1) + gUnk_03002920[0xB].yPosScreen + ((s8)(gUnk_03002920[0xB].yOffset));
                }
            } else {
                gUnk_03000820->split.x = var_r5->unk3 + gUnk_03002920[0xB].xPosScreen + ((s32)(gUnk_03002920[0xB].xOffset << 4) >> 4);
                gUnk_03000820->split.y = gUnk_03002920[0xB].yPosScreen + var_r5->unk4 + ((s8)(gUnk_03002920[0xB].yOffset));
            }
    ...
    if (gUnk_03002920[0xC].onScreen == 1) {
        ...
        for (sp4 = 0; sp4 < temp_r1_4; sp4++) {
            if (gUnk_03002920[0xC].affineDouble) {
                if (gUnk_03002920[0xC].kind == 0x1C) {
                    gUnk_03000820->split.x
                        = (var_r5_2->unk3 * 2) + gUnk_03002920[0xC].xPosScreen + ((s32)(gUnk_03002920[0xC].xOffset) << 4);
                    gUnk_03000820->split.y = var_r5_2->unk4 + ((s8)var_r5_2->unk4 >> 1) + gUnk_03002920[0xC].yPosScreen
                        + (((s8)gUnk_03002920[0xC].yOffset) << 4);
                } else {
                    gUnk_03000820->split.x
                        = (var_r5_2->unk3 * 2) + gUnk_03002920[0xC].xPosScreen + ((s32)(gUnk_03002920[0xC].xOffset << 4) >> 4);
                    gUnk_03000820->split.y = var_r5_2->unk4 + ((s8)var_r5_2->unk4 >> 1) + gUnk_03002920[0xC].yPosScreen
                        + ((s8)(gUnk_03002920[0xC].yOffset));
                }
            } else {
                gUnk_03000820->split.x
                    = var_r5_2->unk3 + gUnk_03002920[0xC].xPosScreen + ((s32)(gUnk_03002920[0xC].xOffset << 4) >> 4);
                gUnk_03000820->split.y = gUnk_03002920[0xC].yPosScreen + var_r5_2->unk4 + ((s8)(gUnk_03002920[0xC].yOffset));
            }
    ...
    for (sp0 = 1; sp0 <= 8; sp0++) {
        if (gUnk_03002920[sp0].onScreen == 1) {
                ...
                for (var_sb = 0; var_sb < temp_r1_9; var_sb++) {
                    if (gUnk_03002920[sp0].affineDouble) {
                        if (gUnk_03002920[sp0].kind == 0x1C) {
                            gUnk_03000820->split.x
                                = (var_r6->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset) << 4);
                            gUnk_03000820->split.y = var_r6->unk4 + ((s8)var_r6->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                                + (((s8)gUnk_03002920[sp0].yOffset) << 4);
                        } else {
                            gUnk_03000820->split.x
                                = (var_r6->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                            gUnk_03000820->split.y = var_r6->unk4 + ((s8)var_r6->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                                + ((s8)(gUnk_03002920[sp0].yOffset));
                        }
                    } else {
                        gUnk_03000820->split.x
                            = var_r6->unk3 + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                        gUnk_03000820->split.y = gUnk_03002920[sp0].yPosScreen + var_r6->unk4 + ((s8)(gUnk_03002920[sp0].yOffset));
                    }
            ...
            if (gUnk_03000830[sp0].unk0 == 7) {
                ...
                for (var_sb_2 = 0; var_sb_2 < temp_r1_13; var_sb_2++) {
                    if (gUnk_03002920[sp0].affineDouble) {
                        if (gUnk_03002920[sp0].kind == 0x1C) {
                            gUnk_03000820->split.x
                                = (var_r6_2->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset) << 4);
                            gUnk_03000820->split.y = var_r6_2->unk4 + ((s8)var_r6_2->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                                + (((s8)gUnk_03002920[sp0].yOffset) << 4);
                        } else {
                            gUnk_03000820->split.x
                                = (var_r6_2->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                            gUnk_03000820->split.y = var_r6_2->unk4 + ((s8)var_r6_2->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                                + ((s8)(gUnk_03002920[sp0].yOffset));
                        }
                    } else {
                        gUnk_03000820->split.x
                            = var_r6_2->unk3 + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                        gUnk_03000820->split.y = gUnk_03002920[sp0].yPosScreen + var_r6_2->unk4 + ((s8)(gUnk_03002920[sp0].yOffset));
                    }
        ...
        if (gUnk_03002920[sp0].onScreen == 1) {
            ...
            for (var_sb_3 = 0; var_sb_3 < temp_r1_18; var_sb_3++) {
                if (gUnk_03002920[sp0].affineDouble) {
                    if (gUnk_03002920[sp0].kind == 0x1C) {
                        gUnk_03000820->split.x
                            = (var_r6_3->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset) << 4);
                        gUnk_03000820->split.y = var_r6_3->unk4 + ((s8)var_r6_3->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                            + (((s8)gUnk_03002920[sp0].yOffset) << 4);
                    } else {
                        gUnk_03000820->split.x
                            = (var_r6_3->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                        gUnk_03000820->split.y = var_r6_3->unk4 + ((s8)var_r6_3->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                            + ((s8)(gUnk_03002920[sp0].yOffset));
                    }
                } else {
                    gUnk_03000820->split.x
                        = var_r6_3->unk3 + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                    gUnk_03000820->split.y = gUnk_03002920[sp0].yPosScreen + var_r6_3->unk4 + ((s8)(gUnk_03002920[sp0].yOffset));
                }
        ...
        if (gUnk_03002920[sp0].onScreen == 1) {
            ...
            for (var_sb_4 = 0; var_sb_4 < temp_r1_22; var_sb_4++) {
                if (gUnk_03002920[sp0].affineDouble) {
                    if (gUnk_03002920[sp0].kind == 0x1C) {
                        gUnk_03000820->split.x
                            = (var_r6_4->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset) << 4);
                        gUnk_03000820->split.y = var_r6_4->unk4 + ((s8)var_r6_4->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                            + (((s8)gUnk_03002920[sp0].yOffset) << 4);
                    } else {
                        gUnk_03000820->split.x
                            = (var_r6_4->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                        gUnk_03000820->split.y = var_r6_4->unk4 + ((s8)var_r6_4->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                            + ((s8)(gUnk_03002920[sp0].yOffset));
                    }
                } else {
                    gUnk_03000820->split.x
                        = var_r6_4->unk3 + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                    gUnk_03000820->split.y = gUnk_03002920[sp0].yPosScreen + var_r6_4->unk4 + ((s8)(gUnk_03002920[sp0].yOffset));
                }
            ...
            if (gUnk_03000830[sp0].unk0 == 1) {
                ...
                for (var_sb_5 = 0; var_sb_5 < temp_r1_26; var_sb_5++) {
                    if (gUnk_03002920[sp0].affineDouble) {
                        if (gUnk_03002920[sp0].kind == 0x1C) {
                            gUnk_03000820->split.x
                                = (var_r6_5->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset) << 4);
                            gUnk_03000820->split.y = var_r6_5->unk4 + ((s8)var_r6_5->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                                + (((s8)gUnk_03002920[sp0].yOffset) << 4);
                        } else {
                            gUnk_03000820->split.x
                                = (var_r6_5->unk3 * 2) + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                            gUnk_03000820->split.y = var_r6_5->unk4 + ((s8)var_r6_5->unk4 >> 1) + gUnk_03002920[sp0].yPosScreen
                                + ((s8)(gUnk_03002920[sp0].yOffset));
                        }
                    } else {
                        gUnk_03000820->split.x
                            = var_r6_5->unk3 + gUnk_03002920[sp0].xPosScreen + ((s32)(gUnk_03002920[sp0].xOffset << 4) >> 4);
                        gUnk_03000820->split.y = gUnk_03002920[sp0].yPosScreen + var_r6_5->unk4 + ((s8)(gUnk_03002920[sp0].yOffset));
                    }
...
void RenderDialogSprites(void) {
    ...
    for (var_sb = 0xD; var_sb < gUnk_03005428; var_sb++) {
        if (gUnk_03002920[var_sb].onScreen == 1) {
                ...
                for (var_sl = 0; var_sl < temp_r1_3; var_sl++) {
                    if (gUnk_03002920[var_sb].affineDouble) {
                        if (gUnk_03002920[var_sb].kind == 0x1C) {
                            gUnk_03000820->split.x
                                = (var_r7->unk3 * 2) + gUnk_03002920[var_sb].xPosScreen + ((s32)(gUnk_03002920[var_sb].xOffset) << 4);
                            gUnk_03000820->split.y = var_r7->unk4 + ((s8)var_r7->unk4 >> 1) + gUnk_03002920[var_sb].yPosScreen
                                + (((s8)gUnk_03002920[var_sb].yOffset) << 4);
                        } else {
                            gUnk_03000820->split.x = (var_r7->unk3 * 2) + gUnk_03002920[var_sb].xPosScreen
                                + ((s32)(gUnk_03002920[var_sb].xOffset << 4) >> 4);
                            gUnk_03000820->split.y = var_r7->unk4 + ((s8)var_r7->unk4 >> 1) + gUnk_03002920[var_sb].yPosScreen
                                + ((s8)(gUnk_03002920[var_sb].yOffset));
                        }
                    } else {
                        gUnk_03000820->split.x
                            = var_r7->unk3 + gUnk_03002920[var_sb].xPosScreen + ((s32)(gUnk_03002920[var_sb].xOffset << 4) >> 4);
                        gUnk_03000820->split.y
                            = gUnk_03002920[var_sb].yPosScreen + var_r7->unk4 + ((s8)(gUnk_03002920[var_sb].yOffset));
                    }
        ...
        if (gUnk_03002920[var_sb].onScreen == 1) {
            ...
            for (var_sb_3 = 0; var_sb_3 < temp_r1_7; var_sb_3++) {
                if (gUnk_03002920[var_sb].affineDouble) {
                    if (gUnk_03002920[var_sb].kind == 0x1C) {
                        gUnk_03000820->split.x
                            = (var_r7_2->unk3 * 2) + gUnk_03002920[var_sb].xPosScreen + ((s32)(gUnk_03002920[var_sb].xOffset) << 4);
                    ...
                    gUnk_03000820->split.x
                        = var_r7_2->unk3 + gUnk_03002920[var_sb].xPosScreen + ((s32)(gUnk_03002920[var_sb].xOffset << 4) >> 4);
                    gUnk_03000820->split.y = gUnk_03002920[var_sb].yPosScreen + var_r7_2->unk4 + ((s8)(gUnk_03002920[var_sb].yOffset));
                }
                        ...
                        if (gUnk_03002920[var_sb].affineDouble) {
                            if (gUnk_03002920[var_sb].kind == 0x1C) {
                                gUnk_03000820->split.x = (var_r7_3->unk3 * 2) + gUnk_03002920[var_sb].xPosScreen
                                    + ((s32)(gUnk_03002920[var_sb].xOffset) << 4);
                            ...
                            gUnk_03000820->split.x
                                = var_r7_3->unk3 + gUnk_03002920[var_sb].xPosScreen + ((s32)(gUnk_03002920[var_sb].xOffset << 4) >> 4);
                            gUnk_03000820->split.y
                                = gUnk_03002920[var_sb].yPosScreen + var_r7_3->unk4 + ((s8)(gUnk_03002920[var_sb].yOffset));
                        }
            ...
            if ((gUnk_03002920[var_sb].yPosScreen + gUnk_03002920[var_sb].unk8) <= sp0) {
                ...
                for (var_sb_5 = 0; var_sb_5 < temp_r1_12; var_sb_5++) {
                    if (gUnk_03002920[var_sb].affineDouble) {
                        ...
                        gUnk_03000820->split.x
                            = var_r7_4->unk3 + gUnk_03002920[var_sb].xPosScreen + ((s32)(gUnk_03002920[var_sb].xOffset << 4) >> 4);
                        gUnk_03000820->split.y
                            = gUnk_03002920[var_sb].yPosScreen + var_r7_4->unk4 + ((s8)(gUnk_03002920[var_sb].yOffset));
                    }
...
void TransformEntityScreenPositions(void) {
    ...
    if (gUnk_03002920[0x9].onScreen == 1) {
    ...
    for (var_r5 = 1; var_r5 < gUnk_03005428; var_r5++) {
        ...
        if (gUnk_03002920[var_r5].unkF < 0x19) {
            ...
            if ((gUnk_03002920[var_r5].xPosScreen >= (DISPLAY_WIDTH + 35) && gUnk_03002920[var_r5].xPosScreen <= (u16)-36)
                ...
                gUnk_03002920[var_r5].onScreen = 0;
            } else {
                gUnk_03002920[var_r5].onScreen = 1;
            }
        }
    }
}
...
extern void UpdatePlayerState(void); /* UpdatePlayerState */
 ...
 *
 * Everything but the pause branch sits under `gUnk_030052A0 == 0xFE`; the tail
 * then runs EntityProjectileUpdate and ApplyEntityTileMovement under their own
 * guards, and the sweep ends with UpdatePaletteAnimations.
 *
 * The pause branch is the guard, not the job. Measured over 120 idle frames in
 * one level it runs once per frame, writes gCallbackQueue zero times and makes
 * 840 calls out to three entity handlers -- three, because that is the entity
 * population of that one savestate, not a property of the switch, which has ~15
 * arms. Pressing START does write the queue, so the zero is a measurement.
 * Runtime: prove-gameplay-entity-update.mjs.
 *
 * UpdateUIState below has the same shape and is still named for something it does
 * not do; it never ran in any savestate here, so it is left alone.
 */
                ...
                switch (gUnk_03002920[var_r6].kind - 7) {
                    ...
                    case 0x9:
                        switch (gUnk_03002920[var_r6].unkF) {
                            ...
                            case 25:
                                ...
                                gUnk_03002920[var_r6].onScreen = 1;
                    ...
                    case 0xE:
                        ...
                        if (gUnk_03000830[0x12 - gUnk_0300363C].unk0 == 0) {
                            ...
                            gUnk_03002920[var_r6].onScreen = 0;
                        }
                        break;
        ...
        switch (gUnk_03002920[var_sb].kind - 6) {
            ...
            case 0x6C:
                if (gUnk_03002920[var_sb].yPosBg2 & 1) {
                    if (gUnk_03002920[var_sb].unk9 == 1) {
                        if (gUnk_03002920[var_sb].unkC_4 == 0) {
                            ...
                            DmaCopy16(
                                3, &gUnk_080635E8,
                                OBJ_VRAM0
                                    + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xE].tileNum << 5),
                                0x80);
                            DmaCopy16(
                                3, &gUnk_080635E8,
                                OBJ_VRAM0
                                    + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xF].tileNum << 5),
                                0x80);
                        } else {
                            DmaCopy16(
                                3, &gUnk_080B9068,
                    ...
                    if (gUnk_03002920[var_sb].unkC_4 == 0) {
                        DmaCopy16(3, &gUnk_08061FC8,
                                  OBJ_VRAM0
                                      + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5),
                                  0x80);
                    } else {
                        DmaCopy16(3, &gUnk_080B8F68,
                                  OBJ_VRAM0
                                      + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5),
                                  0x80);
                    }
            ...
            case 0x6E:
                ...
                if (gUnk_03005220.unk3_6 == 0) {
                    DmaCopy16(3, &gUnk_08063368,
                              OBJ_VRAM0
                                  + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5),
                              0x80);
                } else {
                    DmaCopy16(3, &gUnk_080B92E8,
                              OBJ_VRAM0
                                  + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5),
                              0x80);
                }
            ...
            case 0x6D:
                ...
                if (gUnk_03004C10 == NULL) {
                    gUnk_03004C10
                        = OBJ_VRAM0 + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5);
                }
            ...
            case 0x6F:
                if ((gUnk_03002920[var_sb].unkC_4 == 3) || (gUnk_03002920[var_sb].unkC_4 == 1)) {
                    DmaCopy16(3, &gUnk_08064A68,
                              OBJ_VRAM0
                                  + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5),
                              0x200);
                } else {
                    DmaCopy16(3, &gUnk_080B9668,
                              OBJ_VRAM0
                                  + (gUnk_0818B8E0[gUnk_03004C20.world - 1][gUnk_03004C20.level]->unk4[var_sb - 0xD].tileNum << 5),
                              0x200);
                }
...
/**
 * UpdatePlayerState: one frame of the player's whole update.
 *
 * ONE function, 0x0800D188..0x08014174 -- 28652 bytes with a single entry and a
 * single exit (the `pop {r0}; bx r0` at 0x08014172 is the only return instruction
 * in the range). Measured: over 120 frames the entry runs 120 times and that
 * epilogue runs 120 times. Twenty-seven functions_merged.cfg entries fall strictly
 * inside it -- 0x0800DB18, 0x080101E8 (which even carries the semantic name
 * EntityUpdateDispatch), 0x08011F10 and 24 more -- and they are labels, not
 * functions: agbcc emits `bl` for an intra-function jump past `b`'s +/-2 KB range,
 * so being a `bl` target proves nothing here. Nothing has been done about those 27;
 * `scripts/find_dead_code.py` lists them.
 *
 * Its prologue is two sequential blocks, not alternatives -- the death block ends
 * by branching into the hurt block, so both run on the same frame:
 *   - while gUnk_03005220.deathSequenceTimer is set: swallow input (gNewKeys and
 *     gHeldKeys are zeroed), put entities 1..count-1 into blend mode on the single
 *     frame the timer reads 0x41, set gBlendValue to 0x10 on that same frame and
 *     ramp it down, and on the frame it reads 1 decrement `lives` and hand off to
 *     either the respawn step (sub_08024D84) or the game-over path.
 *   - while gUnk_03005220.hurtStateTimer is set AND unk5B is set: flicker the
 *     player by toggling gUnk_03002920[0].onScreen.
 * Everything after that runs unconditionally, and it is the bulk of the function:
 * measured over 150 frames of walking and jumping, its writes land in
 * gUnk_03002920[0] (the player's position) and in gUnk_03005220 +0x26..+0x4B.
 *
 * It is not a callback: no word in ROM or RAM holds its address, and both callers
 * reach it with a `bl` from a per-frame main-loop function. It carried the name
 * VBlankCallback_Credits, which was wrong on both halves.
 * Runtime: prove-player-damage-state.mjs, prove-invincibility-flicker.mjs,
 * prove-d81a-is-not-a-function.mjs.
 */
INCLUDE_ASM("asm/nonmatchings/code_0", UpdatePlayerState);
