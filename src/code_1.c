...
void PlayerRespawnOrDeath(s32 arg0) {
    ...
    gUnk_03005220.hurtStateTimer = 0x87;
 ...
 *                  still in post-hit invincibility (hurtStateTimer && unk5B).
            ...
            if (gUnk_03002920[j].kind > 0x6D) {
                ...
                if ((u16)(gUnk_03002920[j].xPosBg2 + left) < gUnk_03002920[i].xPosBg2 + 0xC
                    ...
                    switch (gUnk_03002920[j].kind - 0x6E) {
                        case 0:
                            if (gUnk_03005220.hurtStateTimer != 0 && gUnk_03005220.unk5B != 0) {
                                continue;
                            }
 ...
 *
 * Installed as gCallbackQueue.next[1] by UpdatePlayerState (code_0), and run
